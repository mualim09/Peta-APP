    ...
    <script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          center: new google.maps.LatLng(-6.596228, 106.792033),
          zoom: 12
        });
        ...
        var infoWindow = new google.maps.InfoWindow;
          ...
          downloadUrl('http://peta.local/xml/markers.xml', function(data) {
      ...
      <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBbn46MVj1kbVCtIzLbeGWIdxrwuogdOTo&callback=initMap&libraries=places">
    </script>
